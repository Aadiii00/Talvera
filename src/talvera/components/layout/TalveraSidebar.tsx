...
const navItems = [
  ...
  { label: "AI Control Room", to: "/talvera/ai-control-room", icon: Bot },
  { label: "Tech Foundation", to: "/talvera/tech-foundation", icon: ServerCog },
  ...
  { label: "Evidence Graph", to: "/talvera/evidence-graph", icon: Waypoints },
